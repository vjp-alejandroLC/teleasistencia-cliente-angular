...
export class ModificarRelacionPacientePersonaResolveService implements Resolve<IRelacionPacientePersona>{
  ...
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<IRelacionPacientePersona> {
    return this.cargarRelacionPacientePersona.getRelacionPacientePersona(route.params['id']).pipe(
      catchError( error => {
